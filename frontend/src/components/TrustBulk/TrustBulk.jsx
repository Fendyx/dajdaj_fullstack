...
const TrustBulk = () => {
    ...
    const openModal = (e) => {
        ...
        setSelectedProduct({
            ...
            price: 59,
            link: "/trust-bulk",
            image: "https://raw.githubusercontent.com/Fendyx/images/refs/heads/main/Bartosz.png"
        });
    };
            ...
            <div className="body_of_product_info">
                <div className="main-container">
                    <div className="image-section">
                        <model-viewer
                            id="ballViewer"
                            src="/3dObj/TrustBulk/TrustBulk.gltf"
                            shadow-intensity="1"
                            autoplay
                            camera-orbit="-15deg 75deg"
                            camera-controls
                            disable-zoom
                            poster="https://raw.githubusercontent.com/Fendyx/images/refs/heads/main/Bartosz.png"
                        >
                        </model-viewer>
                    </div>
