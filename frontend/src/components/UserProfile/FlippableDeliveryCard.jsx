...
import logo from "../../assets/img/card_design_1.png";

export function FlippableDeliveryCard({ onEdit, onLogOut, isActive = true, style }) {
  ...
  // Берём все нужные поля из state.auth
  const {
    name,
    email,
    clientId,
